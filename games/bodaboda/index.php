					...
					<div class='row'>
						<div class='span4'>
							<div class='projectLogo'>
								<img src='../../img/projects/logos/bodalogo.png'>
							</div>
						</div>
						<div class='container projectPage'>
							<p>
								<span>Boda-Boda</span> is a game designed in partnership with the Red Cross in Uganda as part of a safety and first aid certification course for drivers of motorcycle taxis called boda-bodas. The game is played in-person and pits members of the Red Cross course against one another in a contest to safely obtain as many fares as possible.
							</p>
						</div>
					</div>
					<div class='row'>
						<div class='span6 projectContext'>
							...
							<p>	
								In Uganda, the primary mode of conveyance, other than walking, is the system of motorcycle taxis called &ldquo;boda-bodas.&rdquo; These rides have proven incredibly unsafe, however; more than 60% of all hospital emergency room visits in Uganda are caused by accidents involving boda-bodas. These accidents happen for a variety of reasons, including unsafe driving habits, lack of rest, and poor or insufficient maintenance. When accidents happen, boda-boda riders do not know how to administer first aid, or are too afraid of legal action to help injured passengers and drivers.
							</p>
							<p>
				...
				<div class='realActions extraPadding'>
                    ...
                    <div class='row'>
                        <div class="span12" id="cc">
                            <p>
                            <span xmlns:dct="http://purl.org/dc/terms/" href="http://purl.org/dc/dcmitype/InteractiveResource" property="dct:title" rel="dct:type">Boda Boda</span> by <a xmlns:cc="http://creativecommons.org/ns#" href="http://engagementgamelab.org/games/bodaboda/" property="cc:attributionName" rel="cc:attributionURL">Engagement Lab</a> is licensed under a <a rel="license" href="http://creativecommons.org/licenses/by-nc-sa/4.0/">Creative Commons Attribution-NonCommercial-ShareAlike 4.0 International License</a>.
                            </p>
                        </div>
                    </div>
                </div>
